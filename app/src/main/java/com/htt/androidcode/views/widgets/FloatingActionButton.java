package com.htt.androidcode.views.widgets;
...
public class FloatingActionButton extends View {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.setBackgroundResource(R.mipmap.floatingactionbutton_shadow_layer);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if(mActionIcon != null){
            mActionIcon.setVisible(this.getVisibility()==View.VISIBLE, false);
        }
    }
